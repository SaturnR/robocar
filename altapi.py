...
from thcontrol import Car, Directions
...
def forward():
    try:
        ...
        responce = fire(car.move, Directions.FORWARD, duration, speed)
        print(responce)
        state = car.rcstate
...
def backward():
    ...
    try:
        ...
        speed = int(data['speed'])
        print(duration, speed)
        responce = fire(car.move, Directions.BACKWARD, duration, speed)
        print(responce)
        state = car.rcstate
